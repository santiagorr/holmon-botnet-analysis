/*
 * <blockinfo type="DNSBotMappingFilter" invocation="direct" thread_exclusive="False">
 *   <humandesc>
...
namespace blockmon
{
   	...
   	class DNSBotMappingFilter: public Block
   	{
        int m_ingate_id;
        int m_outgate_id;
    ...
    public:
		/**
		  ...
		  */
        DNSBotMappingFilter(const std::string &name, invocation_type invocation) : 
    ...
    REGISTER_BLOCK(DNSBotMappingFilter,"DNSBotMappingFilter");
